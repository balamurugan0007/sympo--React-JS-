import Espot from "./E-spots.jpeg"
...
export default [
    {
        ...
        "rules":[
            ...
            {
                "id":3,
                "rule":" 7 mins per team to explain their project ",
    ...
    },
    {
        ...
        "rules":[
            ...
            {
                "id":3,
                "rule":" Technical content no general topics.Have to send abstarct before the given date ",
   ...
   
    {
        ...
        "rules":[
            {
                "id":1,
                "rule":"ROUND 1:BIOSCOPE 4 members per Each song consist of 4-5 pictures Pictures will be displayed one by one stop the picture where you guess the song If your guess is right, you'll be given pointsOnly one chance for each song Team with highest points move to the next round"
            },
            {
                "id":2,
                "rule":"ROUND 2:CHILL OUT (BGM) Winning Teams are moved without any change Bgm of a song will be played Team which knows the answer can raise their hands For right answer points will be awarded Team with highest points move to the final round"
            },
            {
                "id":3,
