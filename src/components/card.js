...
const Card = forwardRef(({res},ref) => {
  ...
  return (
    <div className="mx-auto px-4 py-8 max-w-xl w-60 lg:w-96 m-5 lg:h-96 justify-center" ref={ref}>
    <div className=''>
        <div className="bg-white shadow-2xl rounded-lg mb-6 tracking-wide" >
            ...
            <div className="px-4 py-2 mt-2 ">
                ...
                <p className='font-roboto font-thin text-md text-center mt-1 text-slate-600'>( {res.main} )</p>
