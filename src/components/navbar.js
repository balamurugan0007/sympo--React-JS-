...
const Navbar = () => {
  ...
  return (
   ...
   <img src={logo} className='w-40 h-12 m-3' alt='pic'/>
      ...
      <h4 className='font-medium ml-7 m-3  font-poppins text-md cursor-pointer  text-slate-300 hover:text-slate-50 hover:border-b-2 border-blue-700' onClick={()=>navigate('/event_list')}>Events</h4>
