...
const Navbar = () => {
  ...
  return (
   ...
   <img src={logo} className='w-40 h-8 m-3' alt='pic'/>
      ...
      <h4 className='font-medium ml-7 m-3  font-poppins text-md cursor-pointer  text-slate-300 hover:text-slate-50 hover:border-b-2 border-blue-700' onClick={()=>navigate('/event')}>Events</h4>
...
<div className='lg:hidden flex justify-between items-center bg-purple-950 px-1'>
<h4 className='font-bold ml-7 m-3  font-cokie text-2xl cursor-pointer  text-slate-50' onClick={()=>navigate('/')}>
    <img src={logo} className='w-40 h-12' alt='pic'/>
   </h4>
       <NavigationDrawer/>
